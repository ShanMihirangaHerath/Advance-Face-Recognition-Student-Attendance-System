...
class Student:
    def __init__(self, root):
        ...
        # First Image
        img = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/facial-id-collage-concept(1).jpg"
        )
        ...
        # Second Image
        img1 = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/facial-recognition-collage-concept(0).jpg"
        )
        ...
        # Third_image
        img2 = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/facial-recognition-collage-concept(2).jpg"
        )
        ...
        # Background Image
        img3 = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/background_img.jpg"
        )
        ...
        img_left = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/student_ms-1.jpg"
        )
        ...
        # current course
        current_curse_frame = LabelFrame(
            Left_frame,
            bd=2,
            bg="white",
            relief=RIDGE,
        ...
        img_right = Image.open(
            "C:/Users/Solo Coder/Face-Recognition-Python-Project/Face-Recognition-Python-Project-1/collage_image/student_ms-2.jpeg"
        )
    ...
    def add_data(self):
        if (
            self.var_dep.get() == "Select Departmant"
            ...
            try:
                ...
                my_cursor.execute(
                    "INSERT INTO `face-recognizer`.student VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                    (
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            messagebox.showerror(
                "Error", "Student Must Have BeRequired", parent=self.root
            )
        else:
            try:
    ...
    # ===============Generete data set or take photo samples===============
    def generate_dataset(self):
        try:
            ...
            cap = cv2.VideoCapture(
                0
            )  # Change 0 to the appropriate camera index or video file path
            img_id = 0
            while True:
                ...
                if face_cropped(my_frame) is not None:
                    ...
                    cv2.imwrite(
                        file_name_path, face
                    )  # Provide face data as the second argument
                    cv2.putText(
                        face,
                        str(img_id),
                        (50, 50),
