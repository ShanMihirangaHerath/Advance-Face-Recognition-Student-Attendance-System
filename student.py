...
class student:
    def __init__(self, root):
        ...
        dep_combo=ttk.Combobox(current_curse_frame,font=("times new roman",12,"bold"),width=30, state="readonly")
        ...
        course_combo=ttk.Combobox(current_curse_frame,font=("times new roman",12,"bold"),width=30,state="readonly")
        ...
        year_combo=ttk.Combobox(current_curse_frame,font=("times new roman",12,"bold"),width=30,state="readonly")
        ...
        semester_combo=ttk.Combobox(current_curse_frame,font=("times new roman",12,"bold"),width=30,state="readonly")
        ...
        studentID_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        studentName_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        class_div_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        roll_no_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        gender_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        dob_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        email_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        phone_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        address_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        teacher_entry=ttk.Entry(class_student_frame,width=26,font=("times new roman",12,"bold"))
        ...
        # save button
        save_button=Button(btn_frame,text="Save",width=19,font=("times new roman",12),bg="green",fg="white")
        save_button.grid(row=0, column=0)

        # update button
        update_button=Button(btn_frame,text="Update",width=18,font=("times new roman",12),bg="skyblue",fg="white")
